package com.zhbcompany.todo.core.presentation.util

// todo use Strings.xml
object TodoUseCasesStrings {
...
object ContentDescription {
    const val DELETE_TODO_ITEM = "Delete the todo item"
    const val COMPLETE_TODO_ITEM = "Complete the todo item"
    const val ARCHIVE_TODO_ITEM = "Arrive the todo item"
