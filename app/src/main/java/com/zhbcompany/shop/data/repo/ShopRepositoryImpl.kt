...
class ShopRepositoryImpl(
    ...
    override suspend fun getAllShopItems(): List<ShopItemDomain> {
    ...
    /**
     * Adds a new [ShopItemDomain] to both the local database and the remote server.
     *
     * @param item The [ShopItemDomain] to be added. The [ShopItemDomain.id] will be ignored and will be generated by the local database.
     *
     * @return Nothing.
     *
     * @throws Exception If there is an error while adding the [ShopItemDomain] to the local database or the remote server.
     */
